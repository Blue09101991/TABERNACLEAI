...
import {
  Box, Button, Flex, Heading, Text, Input, Textarea, Divider, Image, SimpleGrid, Spinner, useToast, Tooltip,
...
export default function ImageGeneration() {
  ...
  //     // Replace placeholder in the selected image prompt
  //     let finalPrompt = '';
  //     if (selectedImage) {
  //       finalPrompt = selectedImage.prompt.replace('{inputPrompt}', inputPrompt);
  //     }
  ...
  //       setGeneratedImages(prevImages => [...prevImages, `data:image/jpeg;base64,${base64Image}`]);
  //     }
  ...
  //     // Scroll to the generated images section
  ...
  //     }
  //   } finally {
  //     setIsLoading(false); // Set loading to false after all responses are received
  //   }
  // };
  ...
  return (
    <Box p={8} maxW="1200px" mx="auto">
      <Heading mb={6} textAlign="center">AI Images</Heading>
      ...
      <form onSubmit={handleGenerateImage}>
        <Flex alignItems="center" justifyContent="center" mb={4}>
          <Input
            ...
            min={1}
            max={10} // Limit the maximum number of images
            mr={4}
            width="20%"
            size="lg"
          />
        ...
        <Textarea
          placeholder="Enter input prompt (Text Playground)"
          value={inputPrompt}
      ...
      <SimpleGrid columns={[1, 2, 6]} spacing={4} mb={6}>
      ...
      <Flex flexWrap="wrap" justifyContent="center" ref={generatedImagesRef}>
        {generatedImages.map((image, index) => (
          <Box key={index} borderWidth="1px" borderRadius="lg" overflow="hidden" width="30%" mr={4} mb={4}>
