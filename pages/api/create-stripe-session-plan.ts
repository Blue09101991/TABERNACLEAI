...
export default async function handler(
  ...
  if (req.method === 'POST') {
    ...
    try {
      ...
      let tokensToAdd = calculateTokens(unit_amount);
      ...
      const session = await stripe.checkout.sessions.create({
        ...
        mode: 'payment',
        success_url: `${req.headers.origin}/my-plan?plan_success=true&plan_session_id={CHECKOUT_SESSION_ID}&plan_chosenPrice=${unit_amount / 100}`,
