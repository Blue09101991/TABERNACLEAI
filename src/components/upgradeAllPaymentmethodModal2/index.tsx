...
import PaypalModel2 from '../paypalModels/model2';
...
const UpgradeAllPaymentmethodModal2: React.FC<UpgradeModalProps> = ({ isOpen, onClose }) => {
  ...
  }, [router.isReady, router.query, plan_success, plan_session_id, currentUserEmail]);
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} isCentered>
      ...
      <ModalContent>
        ...
        <ModalBody>
          <VStack spacing={4}>
            <Button onClick={() => handleStripePayment(29.99)}>Stripe</Button>
            <Button onClick={() => setBuyCreditsModalOpen(true)}>Paypal</Button>
          </VStack>
        </ModalBody>
        <PaypalModel2 isOpen={isBuyCreditsModalOpen} onClose={() => setBuyCreditsModalOpen(false)} userEmail={currentUserEmail} />
...
export default UpgradeAllPaymentmethodModal2;
