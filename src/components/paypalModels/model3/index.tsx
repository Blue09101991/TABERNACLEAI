...
const PaypalModel3: React.FC<BuyCreditsModalProps> = ({ isOpen, onClose }) => {
                ...
                <ModalBody>
                    <VStack spacing={4}>
                        {showPayPal ? (
                            ...
                            <>
                                <Button onClick={() => { setAmount(10000); setPrice(9.99); setShowPayPal(true); }}>Buy 10000 Credits for $9.99</Button>
                                <Button onClick={() => { setAmount(25000); setPrice(29.99); setShowPayPal(true); }}>Buy 25000 Credits for $29.99</Button>
                                <Button onClick={() => { setAmount(1000000000); setPrice(59.99); setShowPayPal(true); }}>Buy 1000000000 Credits for $59.99</Button>
                            </>
                        )}
                    </VStack>
                </ModalBody>
