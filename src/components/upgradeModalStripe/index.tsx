...
const UpgradeModalStripe: React.FC<UpgradeModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} isCentered>
      <ModalOverlay />
      <ModalContent>
        <ModalHeader>Upgrade Plans</ModalHeader>
        <ModalCloseButton />
        <ModalBody>
          <VStack spacing={4}>
            <Button onClick={() => handleStripePayment(9.99)}>Regular Plan</Button>
            <Button onClick={() => handleStripePayment(29.99)}>Pro Plan</Button>
            <Button onClick={() => handleStripePayment(59.99)}>Annual Plan</Button>
          </VStack>
        </ModalBody>
...
export default UpgradeModalStripe;
